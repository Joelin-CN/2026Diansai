...
本表与 `NewProject1.syscfg` 及 SysConfig 生成的 `Debug/ti_msp_dl_config.h` 一致。SysConfig 1.24 / SDK 2.05 已验证通过。配套总览图：[MSPM0G3507_PINOUT_SUMMARY.png](docs/MSPM0G3507_PINOUT_SUMMARY.png)。
...
| I2C0_SDA | PA0 | H1-1 | PINCM1 / I2C0_SDA | 100 kHz；OLED 与 MCP23017 共用，统一上拉至 3.3 V |
| I2C0_SCL | PA1 | H1-2 | PINCM2 / I2C0_SCL | 100 kHz；OLED 与 MCP23017 共用 |
