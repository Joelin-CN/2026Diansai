 ...
 *   5. Start the DWT-backed platform timebase
 *   6. Bind the STM32 SPI adapter and initialize the ICM42688
 ...
 *
 * On every 10th call:
 *   - Runs Sens-Decision pipeline at 50 Hz
 *   - Skips every downstream stage if any stage fails
 *   - Applies IR corrections and submits a new velocity command only after success
