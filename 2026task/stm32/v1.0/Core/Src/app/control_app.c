/**
 * @file control_app.c
 * @brief Application coordinator implementation (STM32 platform)
 * @date 2026-07-29
 */
...
bool ControlApp_Init(uint8_t target_laps) {
    ...
    printf("[ControlApp] Step 3: IR-tracker init (USART2, ~20s warm-up)...\n");
...
void ControlApp_RunFastCycle(void) {
    ...
    Encoder_Poll();  /* Poll encoder before motion control update */
