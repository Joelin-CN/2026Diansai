...
void Motor_SetSpeed(int16_t left, int16_t right) {
    ...
    // 2026-07-31 physical test: applying "-left" made MOTOR_B run backward.
    // On the current wiring, pass "left" directly so a positive command makes
    // both B-left and C-right wheels drive the car forward.
